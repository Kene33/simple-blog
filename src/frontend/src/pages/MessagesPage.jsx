...
const conversationLabel = (conversation) => conversation?.kind === "group" ? conversation.title || "Группа" : participantOf(conversation).display_name || participantOf(conversation).username || "Пользователь";
